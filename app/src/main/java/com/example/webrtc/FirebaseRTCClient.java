...
public class FirebaseRTCClient implements AppRTCClient, ValueEventListener {
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        if (!dataSnapshot.hasChild(myId)) {
            ...
            handler.post(() -> {
                ...
                try {
                    // iceServerList = requestTurnServers("https://networktraversal.googleapis.com/v1alpha/iceconfig?key=AIzaSyCwhDWNuuYAtMU0PolF1csA_g63YslTcpM"); // 구글의 IceServer 주소
    ...
    private LinkedList<PeerConnection.IceServer> requestTurnServers(String url)
        ...
        connection.setRequestProperty("REFERER", "https://appr.c/");
